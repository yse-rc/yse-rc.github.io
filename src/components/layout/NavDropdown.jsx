  ...
  return (
    <div className={`relative md:inline-block w-full md:w-auto ${className}`}>
      <button
        ...
        className={`w-full md:w-auto px-4 py-2 text-black hover:text-gray-700 active:text-gray-900 font-normal text-lg bg-gray-50 rounded-lg border border-transparent hover:border-blue-700 active:border-black flex items-center justify-center md:justify-start gap-2`}
      ...
      {isOpen && (
        <div className="absolute right-0 md:right-auto md:left-0 mt-1 py-2 bg-gray-50 rounded-lg shadow-lg z-10">
